...
## 3 配置第一个AdguardHome
### 3.1 输入192.168.XX.XX:3000[^2]访问管理界面，若无法访问可使用AI排查问题，参考AI给我的启动命令：
```shell
...
## 4 输入192.168.XX.XX:3001[^2]访问管理界面
...
[^1]: 与2.2设置的端口一致，如果有服务因为DNS缓存出现问题，可以在这里添加对指定域名的DNS(示例：[/baidu.com/]180.76.76.76)
